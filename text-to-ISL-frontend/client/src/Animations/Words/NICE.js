...
export const NICE = (ref) => {
    enqueueGesture(ref, [
        [
            ...
            ["mixamorigRightHandThumb1", "rotation", "x", Math.PI / 10, "+"],
        ],
        [
...
export const NICE = (ref) => {
    enqueueGesture(ref, [
        [
            ...
            ["mixamorigRightHand", "rotation", "z", Math.PI / 14, "+"],
            ["mixamorigRightForeArm", "rotation", "z", Math.PI / 16, "+"],
            ["mixamorigRightArm", "rotation", "z", Math.PI / 14, "+"],
