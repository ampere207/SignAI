...
const QuizGame = () => {
  ...
  return (
    <div className="relative w-full min-h-screen bg-[#6638B7] overflow-hidden">
      {/* Background elements matching Features page */}
      <HeroBackground />
      <StarsCanvas />

      {/* Content container */}
      <div className="relative z-10 pt-20 pb-16 px-4 flex  flex-col items-center justify-center max-w-10xl mx-auto">
        {/* Question Section */}
        <div className="w-full max-w-3xl h-full bg-[#c8abfb] rounded-3xl shadow-lg p-6 text-center">
          <div className=" text-black text-sm font-bold py-2 px-4 rounded-full mb-4">
